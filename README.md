...
Starter built with [Django App Generator](https://app-generator.dev/tools/django-generator/) (an open-source service) using Soft design.
In order to use the sources, follow the build instructions as presented in `Start with Docker` and `Manual Build` sections. 

> [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-soft-1734218199) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-soft-1734218199.git
$ cd django-soft-1734218199
```
